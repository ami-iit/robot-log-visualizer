...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dataVisualizationFrame = QtWidgets.QFrame(parent=self.splitter_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.dataVisualizationFrame.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        ...
        self.pauseButton = QtWidgets.QPushButton(parent=self.dataVisualizationFrame)
        ...
        self.timeSlider = QtWidgets.QSlider(parent=self.dataVisualizationFrame)
        ...
        self.startButton = QtWidgets.QPushButton(parent=self.dataVisualizationFrame)
        ...
        self.timeLabel = QtWidgets.QLabel(parent=self.dataVisualizationFrame)
        ...
        self.splitter = QtWidgets.QSplitter(parent=self.dataVisualizationFrame)
        self.splitter.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.splitter.setChildrenCollapsible(True)
        self.splitter.setObjectName("splitter")
        self.variableTreeWidget = QtWidgets.QTreeWidget(parent=self.splitter)
        ...
        self.variableTreeWidget.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.CustomContextMenu)
        self.variableTreeWidget.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.variableTreeWidget.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.MultiSelection)
        ...
        self.tabPlotWidget = QtWidgets.QTabWidget(parent=self.splitter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        self.meshcatAndVideoTab = QtWidgets.QTabWidget(parent=self.splitter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        self.meshcatAndVideoTab.setTabPosition(QtWidgets.QTabWidget.TabPosition.East)
        ...
        self.meshcatView = QtWebEngineWidgets.QWebEngineView(parent=self.meshcatTab)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(0)
        ...
        self.splitter_3 = QtWidgets.QSplitter(parent=self.yarpTextLogWidget)
        self.splitter_3.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.splitter_3.setObjectName("splitter_3")
        self.yarpTextLogTreeWidget = QtWidgets.QTreeWidget(parent=self.splitter_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.yarpTextLogTreeWidget.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.yarpTextLogTreeWidget.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.SingleSelection)
        ...
        self.yarpTextLogTableWidget = QtWidgets.QTableWidget(parent=self.splitter_3)
        ...
        self.yarpTextLogTableWidget.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.yarpTextLogTableWidget.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustIgnored)
        self.yarpTextLogTableWidget.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.yarpTextLogTableWidget.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.NoSelection)
        self.yarpTextLogTableWidget.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollMode.ScrollPerPixel)
        self.yarpTextLogTableWidget.setShowGrid(False)
        self.yarpTextLogTableWidget.setGridStyle(QtCore.Qt.PenStyle.NoPen)
        ...
        self.logScrollArea = QtWidgets.QScrollArea(parent=self.tab_5)
        ...
        self.logScrollArea.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.logScrollArea.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.SizeAdjustPolicy.AdjustToContents)
        ...
        self.logLabel = QtWidgets.QLabel(parent=self.logScrollAreaWidgetContents)
        self.logLabel.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.ArrowCursor))
        ...
        self.actionSet_Robot_Model = QtGui.QAction(parent=MainWindow)
        self.actionSet_Robot_Model.setObjectName("actionSet_Robot_Model")
        self.actionRealtime_Connect = QtGui.QAction(parent=MainWindow)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSet_Robot_Model.setText(_translate("MainWindow", "Options"))
